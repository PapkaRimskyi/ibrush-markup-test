...
Структура проекта:
  ...
  2. Исходники задания находятся в папке <b>project files</b>.
  3. Собирается все в папку <b>docs</b>
  4. Все файлы распределены по своим разделам (пример - кастомные компоненты находятся в папке <b>custom</b>)
...
Для вашего тестового задания выбрал mobile first.

Оценку статью реализовал на CSS. Когда увидел это задание, то сразу вспомнил видео Вадима Макеева об этих самых звездах.
